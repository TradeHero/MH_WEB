...
<?php if ( have_comments() ) : ?>
	<section id="commentsWrap">
		<h3 id="comments" class="h2">
			<!--Commented out the defeault Comments Header which counts comments and return tile 
			
			<?php /*comments_number(__('<span>No</span> Responses', 'bonestheme'), __('<span>One</span> Response', 'bonestheme'), _n('<span>%</span> Response', '<span>%</span> Responses', get_comments_number(),'bonestheme') );*/?>  to &#8220;<?php/* the_title(); */?>&#8221;  -->
